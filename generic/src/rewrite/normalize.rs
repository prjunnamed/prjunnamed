use prjunnamed_netlist::{Cell, MetaItemRef, RewriteResult, RewriteRuleset, Rewriter};

pub struct Normalize;

impl RewriteRuleset for Normalize {
    fn rewrite<'a>(&self, cell: &Cell, _meta: MetaItemRef<'a>, _rewriter: &Rewriter<'a>) -> RewriteResult<'a> {
        match cell {
